...
public class copypase1 {
	...
	public static void main(String[] args) {
		...
		Actions act = new Actions(driver);
		 ...
		 act.keyDown(firstname, Keys.CONTROL).sendKeys("c").keyUp(Keys.CONTROL).build().perform();
		WebElement lastname = driver.findElement(By.xpath("//*[@name='lastname']"));
		  lastname.click();
		  Actions act1 = new Actions(driver);


		 act1.keyDown(firstname, Keys.CONTROL).sendKeys("p").keyUp(Keys.CONTROL).build().perform();
